...
/***/ function(module, exports, __webpack_require__) {
	...
	var XYNode = React.createClass({displayName: "XYNode",

	    render: function() {
	        return (
	            React.createElement("section", {className:  this.props.type}, 
	                React.createElement("em", null,  this.props.children)
	            )
	        );
	    }
	});
	    ...
	    render: function() {
	        var XYNodes = this.props.data.map(function(x_line) {
	            return x_line.map(function(xy_node) {
	                return (
	                    React.createElement(XYNode, {type: xy_node.type}, 
	                        xy_node.mark
	                    )
	                );
	            });
	        ...
	        return (
	            React.createElement("div", {className: "coordinates", style:  {width: size * 11 + 'px'} }, 
	                XYNodes
	            )
	        );
	    }
	...
	ReactDOM.render(
	    React.createElement(CommentBox, {data:  arrayXY, title:  {name: 'title'} }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "div.coordinates {\n  height: 100px; }\n  div.coordinates ul {\n    width: 10%; }\n\n.content_navigation {\n  border-color: #3bbfce;\n  color: #2b9eab; }\n\n.painting-content-wrapper .coordinates {\n  width: 73px; }\n  .painting-content-wrapper .coordinates section {\n    position: relative;\n    float: left;\n    width: 10px;\n    height: 20px;\n    border-right: 1px solid gray;\n    border-bottom: 1px solid gray; }\n    .painting-content-wrapper .coordinates section em {\n      font-style: normal;\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      transform: translate3d(-50%, -50%, 0); }\n    .painting-content-wrapper .coordinates section.minus em {\n      width: 80%;\n      overflow: hidden; }\n", ""]);
